  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black pt-20">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className=" bg-gray-600/20 shadow-lg rounded-2xl text-gray-100 p-6 space-y-8">
            ...
            <div className="relative">
              ...
              <label
                ...
                className={`absolute bottom-0 right-0 bg-gray-800 hover:bg-gray-700 p-2 rounded-full cursor-pointer transition-all duration-200 ${
                  isUpdatingProfile ? "opacity-60 pointer-events-none animate-pulse" : ""
                }`}
              >
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-gray-50 rounded-lg border border-gray-300 text-gray-800">
                {authUser?.fullName}
              </p>
            </div>
